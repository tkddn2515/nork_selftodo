...
public class TestReporter : MonoBehaviour
{
	...
	void Start()
	{
		...
		rect1 = new Rect(Screen.width * 0.5f - 120, Screen.height * 0.5f - 225, 240, 50);
		rect2 = new Rect(Screen.width * 0.5f - 120, Screen.height * 0.5f - 175, 240, 100);
		rect3 = new Rect(Screen.width * 0.5f - 120, Screen.height * 0.5f - 50, 240, 50);
		rect4 = new Rect(Screen.width * 0.5f - 120, Screen.height * 0.5f, 240, 50);
		rect5 = new Rect(Screen.width * 0.5f - 120, Screen.height * 0.5f + 50, 240, 50);
		rect6 = new Rect(Screen.width * 0.5f - 120, Screen.height * 0.5f + 100, 240, 50);
