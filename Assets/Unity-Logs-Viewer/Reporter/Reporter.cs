...
public class Reporter : MonoBehaviour
{
	...
	void initializeStyle()
	{
		...
		nonStyle.fontSize = (int)(size.y * 0.5f);
		...
		lowerLeftFontStyle.fontSize = (int)(size.y * 0.5f);
		...
		barStyle.fontSize = (int)(size.y * 0.5f);
		...
		evenLogStyle.fontSize = (int)(size.y * 0.5f);
		...
		oddLogStyle.fontSize = (int)(size.y * 0.5f);
		...
		//logButtonStyle.wordWrap = true;
		logButtonStyle.fontSize = (int)(size.y * 0.5f);
		...
		selectedLogStyle.fontSize = (int)(size.y * 0.5f);
		...
		//selectedLogStyle.wordWrap = true;
		selectedLogFontStyle.fontSize = (int)(size.y * 0.5f);
		...
		stackLabelStyle.fontSize = (int)(size.y * 0.5f);
		...
		searchStyle.fontSize = (int)(size.y * 0.5f);
	...
	bool isGestureDone()
	{
		...
		if (gestureLength > gestureBase && gestureSum.magnitude < gestureBase * 0.5f) {
			gestureDetector.Clear();
			gestureCount++;
